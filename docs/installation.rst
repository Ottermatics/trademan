...
To install trademan, run this command in your terminal:

.. code-block:: console

    $ pip install trademan

This is the preferred method to install trademan, as it will always install the most recent stable release.
...
The sources for trademan can be downloaded from the `Github repo`_.
